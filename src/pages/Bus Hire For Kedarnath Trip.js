...
function  BusforKedarnath(){
  ...
  const cardData = 
    ...
    const testimonials = [
      ...
      const contactData = {
        heading: "Bus Hire Services for Kedarnath Trip contact Number:",
        contactNumbers: [
          "+91 8421333435",
          "+91 7875774499",
          "+91 7620411277",
    ...
    return(
        <div>
          <GoogleAnalytics/>
<Helmet>
  <title>Contact: +91 8421333435 | Amruta Travel | Luxury Bus Hire for Kedarnath Trip | Char Dham Yatra Packages From Pune</title>
  <meta name="description" content="Hire a luxury bus with Amruta Travel for Kedarnath trip, Char Dham Yatra, and other Uttarakhand destinations. Available for Pune to Kedarnath, Badrinath, Vrindavan, Kullu Manali, Amarnath Yatra, and more. Book your luxury coach now for an unforgettable journey." />
  <meta name="keywords" content="Luxury Bus Hire for Kedarnath, Char Dham Yatra Bus Package Pune, Kedarnath Bus Hire Pune, Pune to Badrinath Bus Tour Package, Pune to Vrindavan Bus Package, Vrindavan Tour from Pune, Pune to Kullu Manali Bus Tour, Amarnath Yatra Bus Package, Amruta Travels Bus Rental Pune" />
  <meta property="og:title" content="Contact: +91 8421333435 | Amruta Travel | Luxury Bus Hire for Kedarnath Trip | Char Dham Yatra Packages From Pune" />
  <meta property="og:description" content="Explore the majestic Kedarnath and other Char Dham destinations with Amruta Travel’s luxury bus services. Book your Pune to Kedarnath, Badrinath, Vrindavan, Kullu Manali, and Amarnath Yatra trips today. Premium buses for a comfortable and scenic journey." />
  <meta property="og:url" content="https://yourwebsite.com/bus-hire-kedarnath-trip" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://yourwebsite.com/luxury-bus-kedarnath-trip-image.jpg" />
