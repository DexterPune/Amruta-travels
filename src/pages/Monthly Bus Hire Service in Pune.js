...
function  MonthlyBusPune(){
  ...
  const cardData = 
    ...
    const testimonials = [
      ...
      const contactData = {
        heading: "Monthly Bus Service in Pune contact Number:",
        contactNumbers: [
          "+91 8421333435",
          "+91 7875774499",
          "+91 7620411277",
    ...
    return(
        <div>
          <GoogleAnalytics/>
<Helmet>
  <title>Contact: +91 8421333435 | Amruta Travels | Monthly Bus Hire Service in Pune | Corporate Bus Rentals | Amruta Travels</title>
  <meta name="description" content="Looking for monthly bus hire in Pune? Amruta Travels offers 35, 36, 40, 47, 54, and 55-seater buses for corporate employee transportation. Book a luxury Bharat Benz AC bus for a comfortable ride. Available for rental across areas like Kharadi IT Park and more." />
  <meta name="keywords" content="35 36 40 54 55 Seater Bus Hire in Pune, 35,36,40,47,54,55 Seater Company Bus Rental Service In Pune, Bus On Rent in Pune, Monthly Bus Hire For Corporate Employees, 35 Seater Bharat Benz Bus on Rent, Luxury Bus On Rent in Pune, 57 Seater AC Bharat Benz on Rent in Pune, Monthly Bus On Rent in Kharadi IT Park, Amruta Travels Pune On Rent" />
...
<div className="col-12 col-md-7">
    <img src='\img\Keyword Based Image\Keyword Based Image-33.jpg' alt='img'/>
