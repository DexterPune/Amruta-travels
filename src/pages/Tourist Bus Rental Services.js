...
function  ToristBusService(){
  ...
  const cardData = 
    ...
    const testimonials = [
      ...
      const contactData = {
        heading: "Tourist Bus Rental Services in India contact Number:",
        contactNumbers: [
          "+91 8421333435",
          "+91 7875774499",
          "+91 7620411277",
    ...
    return(
        <div>
          <GoogleAnalytics/>
          <Helmet>
  <title>Tourist Bus Rental Services in Pune</title>
  <meta name="description" content="Explore Amruta Travels' tourist bus rental services in Pune. We offer mini, luxury, and sleeper buses for tours, corporate outings, and family vacations in areas like Bibwewadi, Hadapsar, Hinjewadi, and Shivaji Nagar. Book your comfortable tour bus today!" />
  <meta name="keywords" content="Tour Bus Rental in Pune, Tour Bus Rental Cost in Pune, Tourist Bus Rental Services in Bibwewadi, Tourist Bus Rental Services in Hadapsar, Tourist Bus Rental Services in Hinjewadi, Tour Bus Rental Near me Pune, Tour Bus Hire in Pune, Private Tour Bus Rental in Shivaji Nagar, Tour Bus Rental Price, Mini Tour Bus Rental, Hire a Bus for Tour in Pune, Luxury Tour Bus Companies, Luxury Tour Bus Rentals Service, Sleeper Tour Bus Hire Pune, Amruta Travels Pune On Rent" />
...
<div className="col-12 col-md-7">
    <img src='\img\Keyword Based Image\Keyword Based Image-34.jpg' alt='img'/>
